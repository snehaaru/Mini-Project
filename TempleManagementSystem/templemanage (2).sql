...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2022 at 11:42 AM
...
INSERT INTO `booking_temp` (`booking_id`, `d_id`, `u_id`, `status`, `vb_id`) VALUES
(1, 1, 0, 'pending', 0),
(2, 1, 0, 'pending', 0),
(4, 6, 11, 'Booked', 0),
(7, 1, 11, 'Booked', 0),
...
INSERT INTO `darshana` (`did`, `day`, `date`, `time`, `type`, `desc`, `price`) VALUES
(1, 'All Days', '2022-11-29', '04:28:00.000000', 'pooja', 'Daily Pooja', '50'),
(4, 'Sunday', '2022-11-08', '13:59:00.000000', 'vazhipade', 'Arthajama Pooja', '90'),
(5, 'Monday', '2022-11-09', '15:57:00.000000', 'vazhipade', 'Chuttuvilak', '200'),
(6, 'mndy', '2022-11-02', '15:31:00.000000', 'pooja', 'sxjh', '10');
...
(13, '2022-11-16', '16:27:00.000000', 2, '', '', '', '', '', '', '', ''),
(14, '2022-11-16', '16:29:00.000000', 2, '', '', '', '', '', '', '', ''),
(15, '2022-11-16', '16:43:00.000000', 2, '', 'kozhikode', 'Diagram3.dia.png', '123', '9045123687', '2022-11-01', 'male', '');
...
('9sxvukgqurxs5rj2dko0n2w3rp4koqj0', 'eyJ1X2lkIjowfQ:1otrKa:ofEJRQosK0iHdMPW4OcJldCqsz2AGxrLQyzZg0L-dsE', '2022-11-26 14:18:00.675569'),
('du266tytbb92poincwhp54ckmibzb5qe', 'eyJ1X2lkIjowLCJ1aWQiOjExfQ:1otrju:dR0Zx5IX_bEVjFKp64c-te46U8m-CPtSRP2cuNlGdyY', '2022-11-26 14:44:10.455767'),
('umjok95awjyrn1oqd6n79uev65ezb0h3', 'eyJ1X2lkIjowLCJ1aWQiOjExfQ:1outLE:S380c2vWLW1aQO-hANOoibfozDwLrRyGULO5ItPb2Kg', '2022-11-29 10:38:56.100905'),
...
(6, 'food', 32456, '2022-11-15', '00:03:00.000000', 12, 'contributer'),
(7, 'food', 2345, '2022-11-24', '00:43:00.000000', 11, 'monthly aims'),
(8, 'Amount', 2000, '2022-11-01', '22:44:00.000000', 7, 'contributer'),
(9, 'amount', 2000, '2022-11-09', '10:47:00.000000', 7, 'good donation'),
(10, 'amount', 1234, '2022-11-03', '15:40:00.000000', 11, 'good donation'),
(11, 'vilakk', 1000, '1999-05-17', '12:10:00.000000', 13, 'pending');
...
(7, 'user', 'user', 'user', 11),
(8, 'Anil', 'anil', 'user', 12),
(9, 'sneha', 'Alan2323', 'user', 13),
(10, 'sneha', 'Alan2323', 'user', 14),
(11, 'sneha', 'Alan2323', 'user', 15);
...
(13, 'sneha', 'malappuram\r\n', '9526942323', 'sneha@gmail.com', 'ayillyam', 'female', '1999-05-21', 'Alan2323', 'Alan2323'),
(14, 'sneha', 'malappuram', '9526942323', 'sneha@gmail.com', 'ayillyam', 'female', '', 'Alan2323', 'Alan2323'),
(15, 'sneha', 'malappuram', '9526942323', 'sneha@gmail.com', 'ayillyam', 'female', '', 'Alan2323', 'Alan2323');

-- --------------------------------------------------------

--
-- Table structure for table `vazhipadbook`
--

CREATE TABLE `vazhipadbook` (
  `vb_id` int(11) NOT NULL,
...
--
-- Dumping data for table `vazhipadbook`
--

INSERT INTO `vazhipadbook` (`vb_id`, `name`, `date`, `time`, `star`, `gender`, `u_id`) VALUES
(1, 'anju', '2022-11-16', '17:32:00', 'Moolam', 'female', 11),
(2, 'radhika', '2022-11-16', '20:35:00', 'Aswathi', 'female', 11),
(3, 'babin', '2022-11-16', '16:54:00', 'Aswathi', 'male', 11);
...
--
-- Indexes for table `vazhipadbook`
--
ALTER TABLE `vazhipadbook`
...
--
ALTER TABLE `darshanabook`
  MODIFY `da_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `donation`
  MODIFY `do_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- AUTO_INCREMENT for table `vazhipadbook`
--
ALTER TABLE `vazhipadbook`
  MODIFY `vb_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
